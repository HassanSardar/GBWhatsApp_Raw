...
.method final a(FF)V
    ...
    .line 132
    iget-boolean v0, p0, Landroid/support/design/widget/i;->r:Z

    if-nez v0, :cond_2

    .line 133
    iput-boolean v3, p0, Landroid/support/design/widget/i;->r:Z
    ...
    iget v2, p0, Landroid/support/design/widget/i;->h:F
    ...
    .line 139
    :cond_4
    iput v0, p0, Landroid/support/design/widget/i;->j:F

    .line 140
    iput v1, p0, Landroid/support/design/widget/i;->h:F
    ...
    .line 142
    iput v1, p0, Landroid/support/design/widget/i;->g:F

    .line 143
    iput-boolean v3, p0, Landroid/support/design/widget/i;->m:Z
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget v6, p0, Landroid/support/design/widget/i;->h:F
    ...
    .line 2219
    iget-object v0, p0, Landroid/support/v7/c/a/a;->l:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v4, p0, Landroid/support/design/widget/i;->d:Landroid/graphics/RectF;
    ...
    iget v0, p0, Landroid/support/design/widget/i;->e:F
    ...
    iget v3, p0, Landroid/support/design/widget/i;->e:F
    ...
    .line 2287
    iget-object v0, p0, Landroid/support/design/widget/i;->f:Landroid/graphics/Path;
    ...
    iput-object v0, p0, Landroid/support/design/widget/i;->f:Landroid/graphics/Path;
    ...
    .line 2305
    iget-object v10, p0, Landroid/support/design/widget/i;->b:Landroid/graphics/Paint;
    ...
    iget v11, p0, Landroid/support/design/widget/i;->n:I

    aput v11, v4, v5

    const/4 v5, 0x2

    iget v11, p0, Landroid/support/design/widget/i;->o:I

    aput v11, v4, v5

    const/4 v5, 0x3

    iget v11, p0, Landroid/support/design/widget/i;->p:I
    ...
    .line 2314
    :cond_0
    iget-object v9, p0, Landroid/support/design/widget/i;->c:Landroid/graphics/Paint;
    ...
    iget v7, p0, Landroid/support/design/widget/i;->n:I

    aput v7, v5, v6

    const/4 v6, 0x1

    iget v7, p0, Landroid/support/design/widget/i;->o:I

    aput v7, v5, v6

    const/4 v6, 0x2

    iget v7, p0, Landroid/support/design/widget/i;->p:I
    ...
    .line 3210
    iget v0, p0, Landroid/support/design/widget/i;->k:F
    ...
    .line 3213
    iget v9, p0, Landroid/support/design/widget/i;->e:F
    ...
    iget v4, p0, Landroid/support/design/widget/i;->j:F
    ...
    iget-object v1, p0, Landroid/support/design/widget/i;->b:Landroid/graphics/Paint;
    ...
    iget-object v5, p0, Landroid/support/design/widget/i;->c:Landroid/graphics/Paint;
    ...
    iget v4, p0, Landroid/support/design/widget/i;->i:F
